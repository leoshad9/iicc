...
export const seoPages: Record<string, SeoPage> = {
  ...
  '/venues/auditorium': { title: 'B S Abdur Rahman Auditorium | Tariff Plan', description: 'Book the B S Abdur Rahman Auditorium at IICC, New Delhi — 300 theater-style seats, 32 × 24 ft stage, green rooms, shift-wise member and non-member tariff with 18% GST and equipment charges.' },
  ...
  '/services/coffee-shop': { title: 'The Coffee Shop | IICC', description: 'The Coffee Shop at the India Islamic Cultural Centre, Lodhi Road, New Delhi — a quiet lounge for coffee, conversation and reading. Watch a tour of the space.' },
